...
watermark.style = "color:white;opacity:.5;font-size:13px;position:fixed;bottom:25px;left:25px;z-index:150";
...
function menuju(){if(fungtom2==1){window.location = "https://api.whatsapp.com/send?phone=6282365569988&text=" + pesanwhatsapp;}}
